    ...
    <header className={`fixed top-0 z-50 w-full transition-all duration-500 ${scrolled ? "py-2" : "py-4"}`}>
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4">
        ...
        <div className="flex items-center gap-2">
          <LangToggle />
          <a
            href="https://flap.sh/bnb/0x51eb423e01079aa5107129b440d7de4a6d417777"
            target="_blank"
            rel="noreferrer"
    ...
    <section id="top" className="relative pt-32 pb-20 md:pt-40 md:pb-28">
      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a href="https://flap.sh/bnb/0x51eb423e01079aa5107129b440d7de4a6d417777" target="_blank" rel="noreferrer">
            <Button
              size="lg"
...
const CONTRACT = "0x51eb423e01079aa5107129b440d7de4a6d417777";
