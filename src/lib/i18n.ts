...
export const translations = {
  zh: {
    ...
    token: {
      tag: "代币信息", title: "稳如磐石的代币结构",
      name: "代币名称", supply: "总供应量", platform: "启动平台", chain: "链",
    },
    tokenomics: {
      tag: "代币经济学", title: "透明 · 公平 · 飞翔",
      items: [
    ...
    community: {
      tag: "加入蝴蝶军团", title: "一起拍动翅膀 🦋",
      sub: "我们不是金融建议,我们是金融疯狂。加入数千名扇动翅膀的蝴蝶持有者。",
      tw: "在 Twitter 关注", tg: "加入 Telegram",
  ...
  en: {
    ...
    token: {
      tag: "Token Info", title: "Built Different. Built To Flap.",
      name: "Token Name", supply: "Total Supply", platform: "Launch Platform", chain: "Chain",
    },
    tokenomics: {
      tag: "Tokenomics", title: "Transparent · Fair · Flying",
      items: [
    ...
    roadmap: {
      tag: "Roadmap", title: "Three Phases. One Moon.",
      phases: [
